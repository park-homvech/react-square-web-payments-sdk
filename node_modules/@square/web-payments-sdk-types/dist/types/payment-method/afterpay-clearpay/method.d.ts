...
interface AfterpayClearpay extends PaymentMethod {
    ...
    /**
     * Detach the Afterpay/Clearpay payment object.
     ...
     *
     * This functionality is helpful for frameworks in which the component that holds the Afterpay/Clearpay element can be removed
     ...
     * @example
     * await afterpay.detach();
     * @throws {PaymentMethodAlreadyDestroyedError} `Afterpay` has already been destroyed
     */
    detach(): Promise<void>;
    /**
