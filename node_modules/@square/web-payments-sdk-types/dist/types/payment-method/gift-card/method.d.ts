...
interface GiftCard extends PaymentMethod {
    ...
    /**
     * Detach the gift card payment object. The attached element is emptied but event listeners on the gift card remain.
     ...
     *
     * This functionality is helpful for frameworks in which the component that holds the gift card element can be removed
